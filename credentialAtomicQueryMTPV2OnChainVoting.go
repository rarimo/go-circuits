...
type AtomicQueryMTPV2OnChainVotingInputs struct {
	BaseConfig
	// auth
	ID                       *core.ID
...
// atomicQueryMTPV2OnChainVotingCircuitInputs type represents credentialAtomicQueryMTPVoting.circom private inputs required by prover
...
// Validate validates AtomicQueryMTPVotingPubSignals
func (a AtomicQueryMTPV2OnChainVotingInputs) Validate() error {
...
// InputsMarshal returns Circom private inputs for credentialAtomicQueryMTPVoting.circom
func (a AtomicQueryMTPV2OnChainVotingInputs) InputsMarshal() ([]byte, error) {
	...
	s := atomicQueryMTPV2OnChainVotingCircuitInputs{
...
type AtomicQueryMTPV2OnChainVotingPubSignals struct {
	BaseConfig
...
// PubSignalsUnmarshal unmarshal credentialAtomicQueryMTPV2OnChainVoting.circom public signals array to AtomicQueryMTPPubSignals
func (ao *AtomicQueryMTPV2OnChainVotingPubSignals) PubSignalsUnmarshal(data []byte) error {
...
func (ao AtomicQueryMTPV2OnChainVotingPubSignals) GetObjMap() map[string]interface{} {
	return toMap(ao)
}
